...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 17, 2021 at 07:55 PM
...
(2, 'Batchler of Chemical', 'BC', 4, 8, 1, '0', '0', 1, '2021-06-25 23:42:25', NULL, NULL, NULL, NULL),
...
--
-- Table structure for table `tbl_subject_mst`
--

CREATE TABLE `tbl_subject_mst` (
  `subject_id` bigint(20) NOT NULL,
  `subject_name` varchar(100) DEFAULT NULL,
  `subject_code` varchar(50) DEFAULT NULL,
  `subject_type` enum('Core','Optional') DEFAULT NULL,
  `theory_marks` int(11) DEFAULT NULL,
  `practical_marks` int(11) DEFAULT NULL,
  `course_id_fk` bigint(20) DEFAULT NULL,
  `course_year` int(11) DEFAULT NULL,
  `course_semister` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  `created_by` bigint(20) DEFAULT NULL,
  `updated_by` bigint(20) DEFAULT NULL,
  `deleted_by` bigint(20) DEFAULT NULL,
  `is_deleted` enum('0','1') NOT NULL DEFAULT '0' COMMENT '0: subject not deleted 1: subject deleted',
  `is_active` enum('0','1') NOT NULL DEFAULT '0' COMMENT '0: subject active 1: subject inactive'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indexes for table `tbl_subject_mst`
--
ALTER TABLE `tbl_subject_mst`
...
--
-- AUTO_INCREMENT for table `tbl_subject_mst`
--
ALTER TABLE `tbl_subject_mst`
